...
public class ContaCorrenteTest {
    ...
    private Correntista joao,yuri;
    private Conta contaDoJoao,contaDoYuri;
    private long cpfDoYuri = 12346;
    ...
    public void setUp() {
        ...
        yuri = new Correntista("Yuri", cpfDoYuri);
        contaDoYuri = new Conta(4,yuri);
    ...
    public void testarContaInvestimento(){
        ContaInvestimento contaDoYuri = new ContaInvestimento(4,yuri,"Investimento",2);
        contaDoYuri.sacar(contaDoYuri.getSaldoEmReais());
        contaDoYuri.receberDepositoEmDinheiro(500);
        contaDoYuri.AplicarJuros(2,"Investimento");
        contaDoYuri.resgatarTotal();
        assertEquals("Novo total Resgatado",510,contaDoYuri.getSaldoEmReais(),FLOAT_DELTA);
